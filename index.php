...
<?php include 'app/views/parts/header.php' ?>
  ...
  <div id="main">
    ...
    <div class="sectionfilm"><a href="app/views/parts/single.php" class="livepreview"><img src="public/asset/image/<?php echo $film['film_photo_url']; ?>"></a> </div>
    <?php endforeach ?>
  </div>
  <div class="cl">&nbsp;</div>
  <div id="news"  class="livepreview">
    <div class="head">
      <h3>NEWS</h3>
